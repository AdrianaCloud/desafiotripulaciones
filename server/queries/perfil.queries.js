...
const perfilQueries = {
    ...
    createPerfil: `INSERT INTO ${process.env.PERFIL_TABLE} (perfil_id, user_id, preferencias_deportivas, tipo_de_dieta, objetivo_entrenamiento, ciudad, edad, sexo, peso, condicion, altura) VALUES (@perfil_id, @user_id, @preferencias_deportivas, @tipo_de_dieta, @objetivo_entrenamiento, @ciudad, @edad, @sexo, @peso, @condicion, @altura)`,
