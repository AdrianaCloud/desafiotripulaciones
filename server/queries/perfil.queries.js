...
const perfilQueries = {
    ...
    createPerfil: `INSERT INTO ${process.env.PERFIL_TABLE} ( user_id, preferencias_deportivas, tipo_de_dieta, ciudad, objetivo_entrenamiento, edad, sexo, peso, condicion, altura) VALUES (@user_id, @preferencias_deportivas, @tipo_de_dieta, @ciudad, @objetivo_entrenamiento, @edad, @sexo, @peso, @condicion, @altura)`,
